...
Route::get('/images/create', 'App\Http\Controllers\ImageController@index')->name('gallery.index');
Route::get('/', 'App\Http\Controllers\ImageController@create')->name('gallery.create');
Route::post('/images', 'App\Http\Controllers\ImageController@store')->name('gallery.store');
